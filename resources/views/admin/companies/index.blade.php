    ...
    <div class="col-md-6">
        ...
        <div class="box box-info">
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.companies.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.companies.index') }}',
                    headers: {
                ...
                columns: [
                    ...
                    { 'data': 'name' },                    { 'data': 'balance' },                    { 'data': 'country' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.companies.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.companies.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
