    ...
    <div class="col-md-6">
        ...
        <div class="box box-info">
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.employees.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.employees.index') }}',
                    headers: {
                ...
                columns: [
                    ...
                    { 'data': 'name' },                    { 'data': 'birthday' },                    { 'data': 'country' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.employees.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.employees.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
