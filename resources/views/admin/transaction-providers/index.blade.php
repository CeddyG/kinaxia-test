        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <table id="tab-admin" class="table no-margin table-bordered table-hover">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>{{ __('transaction-providers.provider_id') }}</th>
                        <th>{{ __('transaction-providers.product_id') }}</th>
                        <th>{{ __('transaction-providers.company_id') }}</th>
                        <th>{{ __('transaction-providers.quantity') }}</th>
                        <th>{{ __('transaction-providers.employee_id') }}</th>
                        <th></th>
                        <th></th>
                    </tr>
                    </thead>
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.transaction-providers.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.transaction-providers.index') }}',
                    headers: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.transaction-providers.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
