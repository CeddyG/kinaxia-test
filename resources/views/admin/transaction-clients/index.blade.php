        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <table id="tab-admin" class="table no-margin table-bordered table-hover">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>{{ __('transaction-clients.client_id') }}</th>
                        <th>{{ __('transaction-clients.product_id') }}</th>
                        <th>{{ __('transaction-clients.company_id') }}</th>
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.transaction-clients.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.transaction-clients.index') }}',
                    headers: {
