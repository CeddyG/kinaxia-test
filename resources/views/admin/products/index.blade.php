    ...
    <div class="col-md-6">
        ...
        <div class="box box-info">
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.products.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.products.index') }}',
                    headers: {
                ...
                columns: [
                    ...
                    { 'data': 'tax' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.products.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.products.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
