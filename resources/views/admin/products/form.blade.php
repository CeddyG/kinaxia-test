    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="box box-info">	
                ...
                <div class="box-body"> 
                    @if(isset($oItem))
                        {!! BootForm::open()->action( route('admin.products.update', $oItem->id) )->put() !!}
                        {!! BootForm::bind($oItem) !!}
                    @else
                        {!! BootForm::open()->action( route('admin.products.store') )->post() !!}
                    @endif

                        {!! BootForm::text(__('products.name'), 'name') !!}
                        {!! BootForm::text(__('products.price'), 'price') !!}
                        {!! BootForm::text(__('products.tax'), 'tax') !!}
                        {!! BootForm::text(__('products.stock'), 'stock') !!}
